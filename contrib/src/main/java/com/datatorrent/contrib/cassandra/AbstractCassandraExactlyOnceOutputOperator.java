...
public abstract class AbstractCassandraExactlyOnceOutputOperator<T> extends AbstractBatchTransactionableStoreOutputOperator<T, CassandraTransactionalStore> {

	public AbstractCassandraExactlyOnceOutputOperator(){
		super();
	}
